...
# Якщо запускати через докер - потрібно завантажувати змінні середовища
load_dotenv()
...
SECRET_KEY = 'django-insecure-is=e)2sn$s03jw0#8p)3-%o3prdiamow+os5(=gfhg8koz7ore'
...
AUTH_USER_MODEL = 'users.User'  # якщо створюємо кастомну модель
